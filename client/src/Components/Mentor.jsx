...
import FilterMentorsGet from "./FilterMentorsGet.jsx"
      ...
      <div className="container_mentorPage">
        <div className="sidebar">
          ...
          <div className="wrapper-sidebar">
            ...
            <div>
              <button className="submit-group" onClick={handleSubmit} type="submit">Підтвердити</button>
            </div>
          </div>
        </div>
        <div class="main">
          <div class="container__Mentor">
            ...
            <div className="mentor-list">
              <FilterMentorsGet formData={formData}/>
            </div>
          </div>
        </div>
      </div>
